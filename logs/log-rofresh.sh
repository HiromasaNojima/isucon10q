...
cat /var/log/nginx/access.log | alp json -m '/api/estate/[0-9]+,/api/chair/[0-9]+,/api/recommended_estate/[0-9]+,/images/chair/[0-9]+,/images/estate/[0-9]+' --sort=avg -r | tee alp_$(date +%Y%m%d-%H%M%S).txt
